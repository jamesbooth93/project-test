...
from action_registry import action_cost, action_label
...
def build_weekly_view_model(game) -> WeeklyViewModel:
    ...
    return WeeklyViewModel(
        ...
        briefing_text=(ui_config.briefing_narrative_template if ui_config else overview.get("description", "")),
        key_signals=(ui_config.key_signals if ui_config else []),
