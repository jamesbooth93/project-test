...
TEAM_EMPLOYEES = [
    ...
    {"name": "Chloe", "role": "Data Scientist"},
...
class GameState:
    ...
    def end_week(self):
        ...
        scenario_runtime.apply_authored_trajectory_shaping(self)
        update_observed_risk(
            self.G,
            manager_state=self.manager_state,
            founder_state=self.founder_state,
    ...
    def _record_action_outcome(self, action_type, node, outcome, fit, energy_cost, summary, target_override=None, explanation=None):
        ...
        authored_quality = scenario_runtime.authored_action_quality(self, action_type, node=node)
        action_record = {
            "type": action_type,
            "target": target,
            ...
            "authored_quality": authored_quality,
        }
