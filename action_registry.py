...
ACTION_REGISTRY: dict[str, ActionDef] = {
    "do_nothing": ActionDef(
        ...
        presentation=ActionPresentation(
            ...
            description="Hold off and see what becomes clearer next week.",
            past_tense_label="Waited And Observed",
        ),
    ),
    "quick_check_in": ActionDef(
        ...
        presentation=ActionPresentation(
            ...
            description="Have a short conversation to see how one person is doing and what they need right now.",
            past_tense_label="Quick Check-In Held",
        ),
    ),
    "reduce_workload": ActionDef(
        ...
        presentation=ActionPresentation(
            ...
            description="Take pressure off one person by making it clear what can wait.",
            past_tense_label="Priorities Adjusted",
        ),
    ),
    "reallocate_workload": ActionDef(
        ...
        presentation=ActionPresentation(
            label="Reallocate Workload",
            description="Move work from one person to another to rebalance pressure.",
            past_tense_label="Workload Reallocated",
        ),
    ),
    ...
    "check_in_on_load_bearing_risk": ActionDef(
        ...
        presentation=ActionPresentation(
            ...
            description="Ask one person how manageable the work really feels and what they are carrying.",
            past_tense_label="Capacity Checked",
        ),
    ),
    "surface_hidden_support_work": ActionDef(
        ...
        decision_type="diagnostic_support",
        presentation=ActionPresentation(
            label="Review How Work Is Flowing",
            description="Look at where work is getting stuck and who keeps picking it up.",
            past_tense_label="Workflow Reviewed",
        ),
    ),
    "group_mediation": ActionDef(
        ...
        presentation=ActionPresentation(
            label="Resolve Working Tensions",
            description="Step in to reduce friction between people before it spreads further.",
            past_tense_label="Working Tensions Addressed",
        ),
    ),
    "clarify_roles_and_handoffs": ActionDef(
        ...
        sim_aliases=("team_mediation",),
        presentation=ActionPresentation(
            label="Clarify Roles And Handoffs",
            description="Clarify ownership so work stops bouncing back and forth.",
            past_tense_label="Roles And Handoffs Clarified",
        ),
    ),
    ...
    "stress_management_workshop": ActionDef(
        ...
        presentation=ActionPresentation(
            label="Book Stress Management Workshop",
            description="Set up support for the team that helps over time rather than immediately.",
            past_tense_label="Stress Management Workshop Booked",
        ),
    ),
}
