...
CONFLICT_CLUSTER = ScenarioDefinition(
    ...
    runtime_preset={
        ...
        "recommended_actions_by_week": {
            1: [("group_mediation", "focal_employee"), ("quick_check_in", "focal_employee")],
            2: [("clarify_roles_and_handoffs", "focal_employee"), ("offer_coaching_support", "focal_employee")],
        ...
        "recommended_week_tactics": {
            1: "Resolve Working Tensions around {focal}, alongside a Quick Check-In with {focal}",
            2: "Clarify Roles And Handoffs around {focal}, alongside Offer Coaching Support for {focal}",
            ...
            5: "Quick Check-In with {hidden} to keep the quieter secondary risk from building again",
